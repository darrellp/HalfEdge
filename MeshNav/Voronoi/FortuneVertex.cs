...
namespace DAP.CompGeom
{
	...
	public sealed class FortuneVertex : WeVertex
	{
		...
		private bool _fAlreadyOrdered; // True after this vertex has had its edges ordered in post processing
		private bool _fAddedToWingedEdge; // True if this vertex has already been added to the winged edge data structure
