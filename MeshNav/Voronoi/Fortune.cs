...
namespace DAP.CompGeom
{
	...
	///         suffices if you want to merely draw the diagram) so is made optional.
	///     </para>
	///     <para>
	...
	public class Fortune
	{
		...
		/// <param name="points">
		///     Points whose Voronoi diagram will be calculated. If the library is
		///     built for double precision, these should be Vector, else PointF.
		/// </param>
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The beachline which is the primary data structure kept as we sweep
		///     downward through the points
		/// </summary>
